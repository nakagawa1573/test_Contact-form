    ...
    <article  class="login__content">
        <form class="login__content-form" action="/login" method="post">
            ...
            <div class="login__content-form__box">
                ...
                <input class="login__content-form__input" type="text" placeholder="例: test@example.com"
            ...
            <div class="login__content-form__box">
                ...
                <input class="login__content-form__input" type="password" placeholder="例: coachtech1106"
                    name="password">
            </div>
