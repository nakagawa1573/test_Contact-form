    ...
    <article class="register__content">
        <form class="register__content-form" action="/register" method="post" novalidate>
            ...
            <div class="register__content-form__box">
                ...
                <input class="register__content-form__input" type="email" placeholder="例: test@example.com"
            ...
            <div class="register__content-form__box">
                ...
                <input class="register__content-form__input" type="password" placeholder="例: coachtech1106"
                    name="password">
